...
<article class="row-fluid new">
    ...
    <div class="right-block">
        <div class="content">
            ...
            <div class="author"><?php echo ($data->category_one)?$data->category_one->category_name->title:'' ?></div>
            <div><time><?php echo date('d.m.Y | H:i',strtotime($data->date))?></time>
        ...
        <div class="info-bar">
            <i class="icon-eye-open"></i><span><?php echo $count_visited  ?></span>&nbsp
            <a href="<?php echo $url ?>">
            <i class="icon-pen"></i><i class="css-icon css-icon-comment"><?php echo $count_comments  ?></i></a>
            <a href="<?php echo $url.'#comment=1' ?>" class="comment">Коментувати</a>
        </div>
    </div>
</article>